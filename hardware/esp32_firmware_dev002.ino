...
const char* EMERGENCY_BUZZER_ACK_URL = "https://guardwell.onrender.com/api/sensors/emergency-buzzer/DEV-002/ack";
const char* DEVICE_ID = "DEV-002";

// Geofence
const float FACILITY_LAT = 14.700989;
const float FACILITY_LON = 121.032772;
