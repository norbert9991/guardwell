                                    ...
                                    <div className="p-3">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <button
                                                ...
                                                className="mt-1 p-1 rounded hover:bg-[#EEF1F4] cursor-pointer transition-colors"
                                            >
                    ...
                    <div className="p-3 border-t border-[#E3E6EB] bg-white">
                        <div className="flex items-center justify-between text-xs text-[#6B7280]">
                            ...
                            <button
                                ...
                                className="text-[#6FA3D8] hover:text-[#2F4A6D] cursor-pointer hover:underline transition-colors"
                            >
                                Refresh
                            </button>
                        </div>
