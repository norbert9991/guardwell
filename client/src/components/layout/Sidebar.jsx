...
export const Sidebar = () => {
    ...
    return (
        <div className={cn(
            'bg-white border-r border-[#E3E6EB] transition-all duration-300 flex flex-col h-screen sticky top-0 shadow-sm relative',
            collapsed ? 'w-20' : 'w-64'
        )}>
            {/* Collapse/Expand Toggle - floating on sidebar edge */}
            <button
                onClick={() => setCollapsed(!collapsed)}
                className="absolute -right-3 top-7 z-50 w-6 h-6 bg-white border border-[#E3E6EB] rounded-full flex items-center justify-center shadow-md hover:bg-[#EEF1F4] text-[#6B7280] hover:text-[#1F2937] transition-colors"
            >
