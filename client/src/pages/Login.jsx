        ...
        <div className="min-h-screen bg-gradient-to-br from-[#EEF1F4] via-white to-[#E3E6EB] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-fade-in border border-[#E3E6EB]">
                ...
                <div className="px-8 py-8 text-center relative">
                    ...
                    <div
                        className="inline-flex items-center justify-center w-20 h-20 rounded-2xl shadow-lg mb-6 backdrop-blur-xl border border-[#E3E6EB] relative z-10 overflow-hidden bg-white"
                        style={{ animation: 'float 6s ease-in-out infinite' }}
                    >
                        <img src="/GuardwellLogo.png" alt="GuardWell Logo" className="w-16 h-16 object-contain" />
                    </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full h-12 pl-10 pr-12 bg-[#EEF1F4] border border-[#E3E6EB] rounded-lg text-[#1F2937] placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#6FA3D8]/50 focus:border-[#6FA3D8] transition-all"
