...
import { AntigravityBackground, MagneticCard } from '../components/ui/Antigravity';
...
export const Login = () => {
    ...
    return (
        <AntigravityBackground>
            <MagneticCard className="relative w-full max-w-md">
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl w-full overflow-hidden animate-fade-in border border-[#E3E6EB]">
                    {/* Header */}
            ...
            {/* Footer */}
            <div className="absolute bottom-6 text-center text-[#6B7280] text-xs tracking-wider uppercase pointer-events-none">
