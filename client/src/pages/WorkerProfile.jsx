...
import { ArrowLeft, User, Radio, AlertTriangle, FileText, Clock, Loader2, Camera } from 'lucide-react';
                                    ...
                                    <input
                                        ...
                                        onChange={async (e) => {
                                            ...
                                            reader.onload = async (event) => {
                                                ...
                                                try {
                                                    const response = await workersApi.uploadPhoto(worker.id, event.target.result);
