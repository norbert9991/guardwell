...
router.post('/:id/upload-photo', async (req, res) => {
    try {
        ...
        // Validate it's a data URL with allowed image type
        ...
        await worker.update({ profileImage: image });
        res.json({ message: 'Profile photo updated successfully', worker });
    } catch (error) {
...
router.delete('/:id/photo', async (req, res) => {
    try {
        ...
        await worker.update({ profileImage: null });
        res.json({ message: 'Profile photo removed successfully', worker });
    } catch (error) {
